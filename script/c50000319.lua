...
function s.filter2(c,e,tp,m,f)
	return c:IsType(TYPE_FUSION) and (c:IsRace(RACE_FIEND) or c:IsType(TYPE_PENDULUM)) and (not f or f(c))
...
function s.handcon(e)
	return Duel.GetFieldGroupCount(e:GetHandlerPlayer(),LOCATION_MZONE,0)==0 and Duel.IsExistingMatchingCard(s.sdfilter,0,LOCATION_ONFIELD,LOCATION_ONFIELD,1,nil)
end