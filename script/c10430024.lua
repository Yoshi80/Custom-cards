...
function s.spcon(e,c)
	...
	return Duel.GetLocationCount(1-tp,LOCATION_MZONE)>0
		and not Duel.IsExistingMatchingCard(aux.FilterFaceupFunction(Card.IsAttribute,ATTRIBUTE_WATER),tp,LOCATION_MZONE,0,1,nil)
end
...
function s.atlimit(e,c)
	return c:IsFaceup() and c:IsAttribute(ATTRIBUTE_WATER) and c~=e:GetHandler()
end

function s.filter(c)
	return c:IsFaceup() and c:IsCode(74364659)
end
function s.drcon(e)
