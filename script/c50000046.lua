...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 then
		...
		if Duel.SpecialSummon(g,0,tp,tp,true,true,POS_FACEUP)~=0 and mg:GetCount()>0 and Duel.SelectYesNo(tp,aux.Stringid(id,1)) then
			Duel.BreakEffect()
...
function s.tdfilter(c)
	return c:IsSetCard(0x701) and c:IsType(TYPE_MONSTER) and c:IsAbleToDeck()
end
