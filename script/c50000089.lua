...
function s.costfilter(c,e,tp)
	return c:GetOriginalLevel()>0 and c:IsSetCard(0x702) and Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_DECK+LOCATION_HAND+LOCATION_GRAVE+LOCATION_EXTRA,0,1,nil,c,e,tp)
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,s.spfilter,tp,LOCATION_DECK+LOCATION_HAND+LOCATION_GRAVE+LOCATION_EXTRA,0,1,1,nil,tc,e,tp)
